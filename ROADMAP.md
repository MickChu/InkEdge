...
| 版本 | 状态 | Phases | 说明 |
|:----:|:----:|--------|------|
| v0.8 | ✅ | 1~9, 11 | 完整闭环可用（write → check → settle → index） |
| v0.9 | ✅ | +10 | 修复雷达导入bug、GUI页面扩展、英文写作管线 |
| **v0.10** | **当前** | +工具 | Royal Road 爬虫、doc/完整归档、知识库、脚本工具 |
| v0.11 | 下一版 | +20MP | 集成 20 Master Plots 套路引擎 |
...
| 日期 | 版本 | 变更 |
|------|:----:|------|
| 2026-05-27 | v0.10 | 同步 doc/、knowledge/、GUI页面；新增 gen_en_chapter.py（英文写作）、rr_scraper.py（Royal Road爬虫）、intervene.py；修复雷达导入bug；v0.11 将集成 20 Master Plots |
| 2026-05-25 | v0.9 | 修 RadarAgent 导入；GUI 扩展 3 页面；gen_en_chapter.py 英文直写管线 |
